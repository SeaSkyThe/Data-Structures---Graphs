...
int main(void){
    ...
    busca_profundidade(0, "arquivos/1.txt", "arquivos/tabela_profundidade1.txt"); //primeiro parametro é raiz, segundo parametro é arquivo do grafo e o terceiro o arquivo de saida
